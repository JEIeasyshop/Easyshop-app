...
function stageBadge(order, tRow) {
  ...
  if (isLast) return <span className="stage-chip stage-chip-green"><span className="stage-chip-dot">✓</span>{label}</span>
  return <span className="stage-chip stage-chip-blue"><span className="stage-chip-icon">🚚</span>{label}</span>
}
...
export default function OrdersTab({ orders, tracking, addOrder, updateOrder, deleteOrder, customers = [], addCustomer }) {
    ...
    <div>
      ...
      <div className="orders-toolbar">
        <div className="search-wrap">
          ...
          <input className="search-input" type="text" placeholder="Search orders, customers, products…"
        ...
        {filtered.length === 0 ? (
          ...
          <div className="table-wrap">
            <table>
              <thead>
                <tr>
                  <th>Order</th><th>Customer / Goods</th><th>Charged kg</th><th>Stage</th><th>Revenue</th><th></th>
                </tr>
              </thead>
              <tbody>
                {filtered.map(o => {
                  ...
                  return (
                    <tr key={o.id}>
                      ...
                      <td><div style={{fontWeight:600}}>{o.computed_total != null ? formatCurrency(o.computed_total, cur) : <span className="text-muted text-sm">—</span>}</div></td>
                      <td>
      ...
      {confirmDel && (
        <div className="overlay">
          <div className="confirm-modal">
            ...
            <p>This will permanently remove the order from all tabs (Tracking, Invoice, Cost). <strong>This cannot be undone.</strong></p>
